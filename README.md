...
* [Django-CRM](https://github.com/DjangoCRM/django-crm) - Analytical CRM with Tasks management, Email marketing and many more. The CRM software app is built for individual use by businesses of any size or freelancers and is designed to provide easy customization and quick development.
...
* [django-zeal](https://github.com/taobojlen/django-zeal/) - Catch all types of N+1 query before they hit prod, with a nice debugging experience
